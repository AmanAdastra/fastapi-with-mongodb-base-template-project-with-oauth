...
logger.add(sys.stdout, colorize=True, level="DEBUG", format=fmt, enqueue=True, backtrace=True)
logger.enable("logger")
logger.add("./logs/app_log/app.log", colorize=True, rotation=rotator.should_rotate, level="DEBUG", format=fmt, enqueue=True, backtrace=True)
